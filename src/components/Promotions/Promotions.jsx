  ...
  return (
    <div className={css.promotionWrap}>
      ...
      <div className={css.promotion}>
        ...
        <div className={css.promotionContent}>
          <p>
            <b>-20% турбота, якою хочеться ділитися</b>
            <br />
            Приведи подругу (чи друга) — отримай 20% знижки на наступний масаж.
      ...
      <div className={css.promotion}>
        <div className={css.promotionContent}>
          ...
          <p>* знижка діє на індивідуальні масажі</p>
        </div>
      </div>
    </div>
  );
